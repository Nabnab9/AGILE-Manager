[![Build Status](https://travis-ci.com/Nabnab9/AGILE-Manager.svg?branch=master)](https://travis-ci.com/Nabnab9/AGILE-Manager)
...
To optimize the AgileManager application for production, run:
