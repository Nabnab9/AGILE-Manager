...
import { AgileManagerSharedModule, UserRouteAccessService } from './shared';
import { AgileManagerAppRoutingModule} from './app-routing.module';
import { AgileManagerHomeModule } from './home/home.module';
...
@NgModule({
    imports: [
        BrowserModule,
        AgileManagerAppRoutingModule,
        Ng2Webstorage.forRoot({ prefix: 'jhi', separator: '-'}),
        AgileManagerSharedModule,
        AgileManagerHomeModule,
...
export class AgileManagerAppModule {}
